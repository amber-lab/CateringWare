...
Todas as classes estão na raiz do repositório, a diretoria "cat-py-module" contém as mesmas classes e é usada para a compilação do software em executavél usando "cx_Freeze" com o script "setup.py", esta diretoria é movida para os modulos raiz de python onde a biblioteca cx_Freeze irá fazer uma procura automática. Para criar o ficheiro init de "cat-py-module" ira ser criada uma função\
Para correr a aplicação no interpretador Python é necessário usar o ficheiro principal de "CateringWare.py" e mover o ficheiro de inicialização localizado em "cat-py-module" para a diretoria "lib\cat" da instalação Python ou então usar "CateringWareDebug.py" para usar as classes na raiz.
...
CateringPage.py faz parte de uma proxima atualização de lógica de programação. Irá atuar como class abstrata das páginas para melhoria do código. 
...
Esta pagina contém duas Barras de Estado com uma a informar o serviço em uso com o nome de "Objeto em uso", localizada no topo da página, e outra que informará alterações e possíveis erros, localizada do fundo da página.
...
2. Adicionar Menu de Refeições
	...
	- Barra de Estado "Menu Selecionado" de maneira a informar escolha.
![Menu Refeição Serviço](./apresentação/serviço_menu_refeição.png)
3. Adicionar Bar
	- Lista de Bars préviamente criados com nome de "Bars carregados"
		- Clique no item para escolher
...
4. Adicionar Menu de Entradas
	...
	- Escolha multipla "Nível de quantidade" que irá aumentar número de produtos de acordo com nível
...
5. Adicionar Menu de Sobremesas
	...
	- Barra de Estado "Menu de Sobremesas Selecionado" de maneira a informar escolha.
	- Escolha multipla "Nível de quantidade" que irá aumentar número de produtos de acordo com nível
...
6. Gestão da Equipa
	...
	- Tabela de Trabalhadores do Serviço
		...
		- Horas de serviço
			- Número de horas adicionadas pelo butão adicionar
		- Botão adicionar
			- Adiciona número de horas inseridas em "Número de horas"
![Equipa Serviço](./apresentação/serviço_equipa.png)
7. Material de Montagem
	- Tipo de Mesa
		- Redonda ou Retangular
		- Influencía número de mesas necessárias
	- Mesas extra
		- Corresponde ao número de mesas extra para a funcinalidade do serviço
		- Mesas Retângulares
![Montagem Serviço](./apresentação/serviço_montagem.png)
8. Resultados Finais
	- Montagem
		Crição de relatório acerca de número de items necessários para o funcionamento do serviço.
	- Valores
		Criação de relatório acerca de valores gastas e estimativa de retorno de valores baseados nos produtos necessários
	- Produtos
