...
class CateringMenuPage(tk.Frame):
    def __init__(self, master):
        ...
        title_bar = CateringPageTitleLabel(self.main_frame.interior, 'Gestão de Ementas', self.photo)
        title_bar.place(relx = 0.05, y = 50, relwidth = 0.9, height = 60)
        
        new_separator = CateringPageTitleLabel(self.main_frame.interior, 'Criar Nova Ementa', self.photo)
        new_separator.place(relx = 0.1, y = 130, relwidth = 0.8, height = 30)
        
        self.name_entry = CateringPageLabeledEntry(self.main_frame.interior, 'Nome da Ementa', self.photo, default_text = 'Inserir Nome Ementa')
        self.name_entry.place(relx = 0.15, y = 180, relwidth = 0.7, height = 30)
        
        menu_prod_label = CateringPageTitleLabel(self.main_frame.interior, 'Produtos da Ementa', self.photo)
        menu_prod_label.place(relx = 0.1, y = 230, relwidth = 0.8, height = 30)
        
        self.menu_prod_listbox = CateringPageScrollBarList(self.main_frame.interior, 'Pratos da Ementa', self.photo,  VERDE)
        self.menu_prod_listbox.place(relx = 0.1, y = 280, relwidth = 0.3, height = 150)
        self.menu_prod_listbox.listbox.bind('<Double-Button-1>', self.delFromEmenta)
        ...
        self.menu_drinks_prod_listbox = CateringPageScrollBarList(self.main_frame.interior, 'Bebidas da Ementa', self.photo,  VERDE)
        self.menu_drinks_prod_listbox.place(relx = 0.6, y = 280, relwidth = 0.3, height = 150)
        self.menu_drinks_prod_listbox.listbox.bind('<Double-Button-1>', self.delFromEmenta)
        ...
        self.menu_soup_listbox.listbox.bind('<Double-Button-1>', self.setToEmenta)
        ...
        self.menu_meat_listbox.listbox.bind('<Double-Button-1>', self.setToEmenta)
        ...
        self.menu_fish_listbox.listbox.bind('<Double-Button-1>', self.setToEmenta)
        ...
        self.menu_drinks_listbox.listbox.bind('<Double-Button-1>', self.setToEmenta)
        ...
        manager_separator = CateringPageTitleLabel(self.main_frame.interior, 'Gerir Ementa', self.photo)
        manager_separator.place(relx = 0.1, y = 890, relwidth = 0.8, height = 30)
        
        self.manager_entry = CateringPageLabeledEntry(self.main_frame.interior, 'Nome da Ementa', self.photo, on_default = False)
        ...
        self.save_b.bind('<ButtonRelease-1>', self.saveEmenta)
        ...
        self.load_b.bind('<ButtonRelease-1>', self.loadEmenta)
        ...
        self.delete_b.bind('<ButtonRelease-1>', self.deleteEmenta)
    ...
    def saveEmenta(self, event):
        ...
        print(name)
        try:
            self.obj = CateringCourseEmenta(name)
            ...
            self.obj = CateringCourseEmenta.load(name)
